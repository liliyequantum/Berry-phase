...
filename='./data_J_t/Bloch_Oscillation_alpha_T3_alpha_0_dp_x_0.0020162_dp_y_0.0019947_E_0.03_t_max_1000_dt_0.005';
...
load(strcat(filename,'.mat'))
t_B=4*pi/sqrt(3)/electric_field;
E_0=pi^2/4;
figure(1)
plot(t,(J_intra+J_inter)./electric_field/E_0/2,'color',color_yellow,'LineWidth',2)
hold on
plot(t,10/sqrt(3)/sqrt(electric_field)/E_0/2*sin(2*pi*t/t_B),'color',color_blue,'LineWidth',2)
hold on
...
%     'Fontname', 'Times New Roman','FontSize',16)
xlabel('$t$','Interpreter','latex','Fontname', 'Times New Roman','FontSize',16)
% ylabel('J/E','Fontname', 'Times New Roman','FontSize',16)
ylabel('$J/E$','Interpreter','latex','Fontname', 'Times New Roman','FontSize',16)
